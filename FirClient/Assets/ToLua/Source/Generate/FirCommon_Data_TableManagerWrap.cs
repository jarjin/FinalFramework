...
public class FirCommon_Data_TableManagerWrap
{
	...
	static int get_globalConfigTable(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			FirCommon.Data.TableManager obj = (FirCommon.Data.TableManager)o;
			FirCommon.Data.GlobalConfigTable ret = obj.globalConfigTable;
			ToLua.PushObject(L, ret);
			return 1;
		}
		catch(Exception e)
	...
	static int set_globalConfigTable(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			FirCommon.Data.TableManager obj = (FirCommon.Data.TableManager)o;
			FirCommon.Data.GlobalConfigTable arg0 = (FirCommon.Data.GlobalConfigTable)ToLua.CheckObject<FirCommon.Data.GlobalConfigTable>(L, 2);
