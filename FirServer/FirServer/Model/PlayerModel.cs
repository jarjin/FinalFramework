...
namespace FirServer.Model
{
    public class PlayerModel : BaseModel
    {
        ...
        public PlayerModel() : base("player")
        {
        }
        ...
        /// <returns></returns>
        public long AddPlayer(List<string> values)
        {
        ...
        /// <param name="values"></param>
        /// <returns></returns>
        public long ExistPlayer(List<string> values = null)
        {
        ...
        {
            return base.Get(uid, "playername");
        }

        public void SetPlayerName(string uid, string value)
        {
            base.Set(uid, "playername", "str:" + value);
        }
